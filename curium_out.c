...
static inline int curium_add(int, int);


/* Closure Functions */
void curium_main()
{
    curium_println(curium_string_new("=== Restrictions (Immutability) Test ==="));
    const int curium_x = 42;
    curium_print(curium_string_new("Immutable x = "));
    curium_println(curium_x);
    int curium_y = 10;
    curium_print(curium_string_new("Mutable y before = "));
    curium_println(curium_y);
    curium_y = 20;
    curium_print(curium_string_new("Mutable y after  = "));
    curium_println(curium_y);
    struct Point {
        int x;
        int y;
    ...
    curium_p.x = 3;
    curium_p.y = 4;
    curium_print(curium_string_new("Point: ("));
    curium_print(curium_p.x);
    curium_print(curium_string_new(", "));
    curium_print(curium_p.y);
    curium_println(curium_string_new(")"));
    const int curium_result = curium_add(10, 20);
    curium_print(curium_string_new("add(10, 20) = "));
    curium_println(curium_result);
    curium_println(curium_string_new("Restriction tests passed!"));
}

static int curium_add(const int curium_a, const int curium_b)
{
    return (curium_a + curium_b);
}
